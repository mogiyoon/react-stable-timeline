...
function Timeline({
  ...
  const [canvasPx, setCanvasPx] = react.useState(800);
  react.useEffect(() => {
  ...
  const packInput = react.useMemo(() => toPackInput(items), [items]);
  const measureLabel = react.useMemo(() => makeLabelMeasurer("11px sans-serif"), []);
  const fitWindow = react.useMemo(() => {
  ...
  const timeToPx = react.useCallback(
    (ms) => (ms - viewportStart) * pxPerMs,
    [viewportStart, pxPerMs]
  );
  const clampViewport = react.useCallback(
    (start, end) => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className, style: containerStyle, children: [
    !hideToolbar && /* @__PURE__ */ jsxRuntime.jsxs("div", { style: toolbarStyle, children: [
      /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: handleFit, style: buttonStyle, children: labels.fit }),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        "label",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { children: labels.zoomRatio }),
            /* @__PURE__ */ jsxRuntime.jsx(
              "input",
              {
                type: "number",
                ...
                return /* @__PURE__ */ jsxRuntime.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntime.jsx("span", { style: { marginTop: 2, padding: "0 4px" }, children: tick.label })
                    ]
                  },
                  `tick-${tick.ms}`
                );
