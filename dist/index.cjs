...
function Toolbar({
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { style: toolbarStyle, children: [
    /* @__PURE__ */ jsxRuntime.jsx("button", { type: "button", onClick: onFit, style: buttonStyle, children: labels.fit }),
    /* @__PURE__ */ jsxRuntime.jsx(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntime.jsxs("label", { style: zoomLabelStyle, children: [
